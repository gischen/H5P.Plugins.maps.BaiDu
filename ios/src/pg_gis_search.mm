...
- (void)evalRouteErrorJavascript
{
    ...
    NSMutableString *jsResult = [NSMutableString stringWithFormat:jsonResultF,_UUID];
    [jsBridge asyncWriteJavascript:jsResult];
}
...
- (void)evalPoiErrorJavascript
{
    ...
    window.plus.maps.__bridge__.execCallback('%@', args);";
    NSMutableString *jsResult = [NSMutableString stringWithFormat:jsonResultF, _UUID];//poiList
    [jsBridge asyncWriteJavascript:jsResult];
}
